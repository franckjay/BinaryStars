...
c
c   UPDATE March 27, 2009
c
c   Make the model atmosphere computations single precision.
c
c
c   Dimension the variables needed for the model atmospheres here.
c
          real*4 atmT,atmg,atmmu
          real*4 atmint1,atmint2,atmint3,atmint4
          real*4 atmint5,atmint6,atmint7,atmint8
          parameter (maxlines=1100,maxmu=99)  ! was 960

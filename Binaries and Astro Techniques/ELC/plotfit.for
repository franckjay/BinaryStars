...
c
c
          dimension xmodel(500000),ymodel(500000),xdata(500000),ydata(500000)
          dimension xinter(500000),yinter(500000),err(500000)
          dimension errplot(500000),y2(500000),xpad(500000),ypad(500000)
          dimension xdummy(500000),ydummy(500000),xplot(500000),yplot(500000)
          character*40 filein,fileout
          character*130 txt
          real*8 zzy,zzx !,chi1,chi2,chi3,chiall,small
c
...
c
          ymin=1000.
          ymax=-1000.
          do 10 i=1,500000                            ! read in the model here
            read(20,*,end=15)zzx,zzy
            xmodel(i)=sngl(zzx)
            ymodel(i)=sngl(-2.5*dlog10(zzy))
 10       continue
 15       Nmodel=i-1
          close(20)
c
...
c
 ...
 25       Ndata=i-1
          close(23)
c          write(*,*)Ndata,Nmodel,ymin,ymax
c
...
c   phase values
c
          call spline(xpad,ypad,Mmodel,0.0,0.0,y2)
c
          do 30 i=1,Ndata
...
c
          ...
          call pgscf(2)
          call pgsch(1.2)
          call pgenv(0.0,2.0,yhi+0.02,ylow-0.02,0,0)
c
          do 2000 i=1,Ndata
            call pgpoint(1,xplot(i),yplot(i),17)
            call pgpoint(1,xplot(i)+1.0,yplot(i),17)
            et=yplot(i)+errplot(i)
            eb=yplot(i)-errplot(i)
            call pgerry(1,xplot(i),et,eb,1.0)
            call pgerry(1,xplot(i)+1.0,et,eb,1.0)
 2000     continue
c
...
c
 ...
 200      continue
          ...
          call pgline(Nmodel,xmodel,ydummy)
c
...
c
c
          call pglabel('Phase','Relative Magnitude',' ')
c
c
